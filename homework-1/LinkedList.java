  ...
  /********* ADD YOUR SOLUTIONS HERE *****************/  
    ...
    public void reverse() {
      ...
      while(current.next.next != null){
        Node<T> movedNode = current.next;
        
        movedNode.next.prev = current;
        current.next = movedNode.next;
        
        movedNode.next = beginMarker;
        beginMarker.prev = movedNode;
        
        movedNode.prev = null;
        
        beginMarker = movedNode;
      }
      
      current.next.next = beginMarker;
      beginMarker.prev = current.next;
      current.next.prev = null;
      beginMarker = current.next;
